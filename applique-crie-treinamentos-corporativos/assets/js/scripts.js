jQuery(document).ready(function() {
  ...
  function emailCorporativo(email) {
    ...
    $("#cadastrar").on('click',function (e) {
        ...
        var tem_lms = $('#tem_lms').val();
        var tempo_lms = $('#tempo_lms').val();
        ...
        if(!nome){
          ...
          var data_array = [
              ...
              { name: 'Número de colaboradores', value: nro_colaboradores},
              { name: 'Tempo de LMS', value: tempo_lms},        
              ...
              { name: 'identificador', value: 'LP Mobiliza Applique'}
          ];
          ...
          setTimeout(function () {
            location.href = "comece-sua-jornada-com-applique.html";
          }, 1000);
